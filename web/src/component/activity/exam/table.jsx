    ...
    const columns = [
        {
            key: 'member',
            title: labels.member,
            dataIndex: ['member_obj', 'label']
        },
        {
            key: 'contest',
            title: labels.contest,
            dataIndex: ['contest_obj', 'label']
        },
        {
            key: 'score',
            title: labels.score,
        ...
        {
            key: 'start_at',
            title: labels.started_at,
            dataIndex: 'started_at',
            render: (text) => Util.isoToReadableDatetimeStr(text)
        },
        {
            key: 'finish_at',
            title: labels.finished_at,
            dataIndex: 'finished_at',
            render: (text) => Util.isoToReadableDatetimeStr(text)
        },
        {
            key: 'submitted_at',
            title: labels.submitted_at,
