...
export const labels = {
    ...
    participated_city_id: t`Thành phố`,
    participated_district_id: t`Quận (và tương đương)`,
    participated_chapter_id: t`Đoàn cơ sở, Chi Đoàn cơ sở`,
    participated_grassroots_id: t`Chi Đoàn`,
